...
import ua.ksstroy.dao.implementations.WorkTypeDaoImpl;
...
public class WorkModelToWorkConveter implements Converter<WorkModel, Work> {
    @Override
    public Work convert(WorkModel workModel) {
        ...
        work.setType(new WorkTypeDaoImpl().convertWorkTypeModelToWorkType(workModel.getType()));
